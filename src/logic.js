...
export function starsFor(score, thresholds, damagedCount) {
  ...
  if (!Number.isInteger(damagedCount) || damagedCount < 0) {
    throw new Error("starsFor: damagedCount must be a non-negative integer");
  }
  let stars = 0;
